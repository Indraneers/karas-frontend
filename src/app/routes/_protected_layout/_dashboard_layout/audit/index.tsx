...
export function AuditPage() {
  ...
  const [auditService, setAuditService] = useState<AuditServiceEnum>(
    AuditServiceEnum.SALE,
  );
  ...
  return (
    <Section>
      <SectionHeader>
        <TypographyH1>Audit</TypographyH1>
      </SectionHeader>
      <SectionContent>
        <div>
          <Select
            value={auditService}
            onValueChange={(service: AuditServiceEnum) =>
