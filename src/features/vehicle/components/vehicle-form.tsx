...
const formSchema = z.object({
  ...
  makeAndModel: z
    .string({ message: "Make and Model are required" })
    .min(3)
    .max(75),
  customer: z.object({
    id: z.string(),
...
const defaultData: VehicleDto = {
  ...
  plateNumber: "",
  makeAndModel: "",
  customer: { id: "", name: "", note: "", address: "", contact: "" },
  mileage: 0,
  vinNo: "",
  engineNo: "",
  note: "",
...
export function VehicleForm({
  ...
  const form = useForm<VehicleFormValues>({
    ...
    defaultValues: data as VehicleFormValues,
  });
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Set Vehicle Type</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="number"
                        placeholder="Ex: 60000 miles"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>Set Mileage</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Set Vin Number</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Set Engine Number</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      className="w-75"
                      placeholder="Ex: Toyota Prius 2024"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      className="w-[300px]"
                      placeholder="Ex: 2HGFG21588H705472"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>Set Vin Number</FormDescription>
